  ...
  return (
    <div className="container mx-auto md:mb-56 ">
        ...
        <div className="flex mx-auto md:flex-col pt-5 md:pt-10 relative">
            <div className='top-[100px] md:absolute text-center md:text-left w-[720px] h-[221px] uppercase'>
            ...
            <div className='w-auto absolute flex flex-col top-[100px] bottom-0 right-0 md:w-[589px] items-center'>
                 <Image src="/Group-4743.png" width={500} height={144}  className='mt-28 md:mt-20' alt=''/>
