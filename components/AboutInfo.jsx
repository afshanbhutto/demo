...
const AboutInfo = () => {
  return (
    <div className="container  w-[500px] h-[500px] md:h-screen md:w-full max-h-fit mx-auto   mb-72 md:m-0 p-0">
        ...
        <div className="flex mx-auto md:flex-col pt-5 md:pt-10 relative justify-center">
            <div className='top-[100px] md:absolute text-center md:text-left md:w-[500px] h-[200px] uppercase'>
                ...
                <h1 className='tracking-[0.8rem] text-5xl font-semibold'>WorldWide</h1>
            </div>
